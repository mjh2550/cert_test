...
//	ks_aria.h
//
#ifndef __KS_ARIA_H__
#define __KS_ARIA_H__
...
int KS_ARIA_GenerateKey(KS_ARIA_KEY *ariaKey, KS_BYTE *key, KS_WORD keyLength, int dir);
void KS_ARIA_Main(KS_ARIA_KEY *ariaKey, KS_BYTE output[16], KS_BYTE input[16]);
